...
export const TextGenerationApis = [
    {
        id: "dataforseo-text-generation",
        name: "Text Generation API",
        description: "Spezialisierte Text-Generierungs-APIs mit 2 verschiedenen Endpoints für text-basierte und topic-basierte Content-Erstellung. Optimiert für bessere Performance durch Trennung von der Haupt-Content-Generation API.",
        ...
        schema: {
            ...
            info: {
                ...
                description: "2 APIs für Text-basierte und Topic-basierte Content-Generierung. Optimiert für bessere Performance durch Trennung von der Haupt-Content-Generation API.",
                version: "v1.0.0",
                contact: {
                    name: "DataForSEO",
