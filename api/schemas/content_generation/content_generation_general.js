...
export const ContentGenerationGeneralApis = [
    {
        id: "dataforseo-content-generation-general",
        name: "Content Generation General API",
        description: "Umfassende Content-Generation-APIs für Text-Generierung, -Analyse, -Optimierung und -Verarbeitung. Kombiniert alle Content-Generation-Funktionalitäten in einer einheitlichen API.",
        ...
        schema: {
            ...
            info: {
                ...
                description: "Vollständige Content-Generation-API mit allen Funktionen: Text-Generierung, Text-Analyse, Content-Optimierung und Text-Verarbeitung. Optimiert für umfassende Content-Erstellung und -Optimierung.",
                version: "v1.0.0",
                contact: {
                    name: "DataForSEO",
