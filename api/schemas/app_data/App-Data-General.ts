...
export const AppDataGeneralSchemaComplete: ToolApi[] = [
  {
    ...
    schema: {
      ...
      info: {
        ...
        description:
          "Vollständige API für alle App Data Funktionen mit 13 spezialisierten Endpunkten: Core APIs (3), Apple Store Data & Search (5), Google Play Data & Search (5). Professionell optimiert für mobile App-Marktanalyse und App-Intelligence mit korrekten DataForSEO API-Pfaden.",
        version: "v1.1.0",
        contact: {
          name: "DataForSEO",
