...
export const AppleStoreSearchApis = [
    {
        id: "dataforseo-apple-store-search",
        name: "Apple Store Search API",
        description: "Spezialisierte Apple App Store Suche mit 8 verschiedenen APIs: App Searches, App Listings, Kategorien, Locations und Languages. Optimiert für iOS App-Recherche und Marktanalyse.",
        category: "App Data - Apple Search",
        icon: "🍎",
        ...
        schema: {
            openapi: "3.1.0",
            info: {
                title: "DataForSEO App Data API - Apple Store Search",
                description: "8 APIs für Apple App Store Suche: App Searches, App Listings, Kategorien, Locations und Languages. Optimiert für iOS App-Marktanalyse und Keyword-Recherche.",
                version: "v1.0.0",
                contact: {
                    name: "DataForSEO",
            ...
            paths: {
                "/apple_store_search_live_advanced": {
                    post: {
                        summary: "Apple App Store Suche (Live Advanced)",
