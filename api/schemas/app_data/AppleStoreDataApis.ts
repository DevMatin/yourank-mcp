...
export const AppleStoreDataApis: ToolApi[] = [
  {
    ...
    schema: {
      ...
      info: {
        ...
        description:
          "9 APIs für detaillierte Apple App Store Daten: App Info, App Reviews und App Lists. Umfassende iOS App-Marktanalyse und App-Intelligence.",
        version: "v1.0.0",
        contact: {
          name: "DataForSEO",
