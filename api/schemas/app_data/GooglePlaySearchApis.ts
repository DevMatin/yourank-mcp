...
export const GooglePlaySearchApis: ToolApi[] = [
  {
    ...
    schema: {
      ...
      info: {
        ...
        description:
          "10 APIs für Google Play App-Suche: App Searches, App Listings, Kategorien, Locations und Languages. Optimiert für mobile App-Marktanalyse und Keyword-Recherche.",
        version: "v1.0.0",
        contact: {
          name: "DataForSEO",
