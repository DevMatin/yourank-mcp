...
export const AppleStoreSearchApis: ToolApi[] = [
  {
    id: "dataforseo-apple-store-search",
    name: "Apple Store Search API",
    description:
      "Spezialisierte Apple App Store Suche mit 8 verschiedenen APIs: App Searches, App Listings, Kategorien, Locations und Languages. Optimiert für iOS App-Recherche und Marktanalyse.",
    ...
    schema: {
      ...
      info: {
        ...
        description:
          "8 APIs für Apple App Store Suche: App Searches, App Listings, Kategorien, Locations und Languages. Optimiert für iOS App-Marktanalyse und Keyword-Recherche.",
        version: "v1.0.0",
        contact: {
          name: "DataForSEO",
