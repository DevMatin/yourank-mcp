...
export const DomainAnalyticsGeneralSchema = [
    {
        id: "dataforseo-domain-analytics-general",
        name: "Domain Analytics General API - Alle Domain Analytics Funktionen",
        description: "Vereinheitlichte Domain Analytics API mit allen Funktionen: Core APIs, Technologies APIs, WHOIS APIs und erweiterten Domain-Analyse-Funktionen. Umfassende Domain-Intelligence und Technologie-Analyse.",
        ...
        schema: {
            ...
            info: {
                ...
                description: "Vereinheitlichte API für alle Domain Analytics Funktionen: Core APIs, Technologies APIs, WHOIS APIs und erweiterte Domain-Analyse. Optimiert für umfassende Domain-Intelligence und Technologie-Analyse.",
                version: "v1.0.0",
                contact: {
                    name: "DataForSEO",
