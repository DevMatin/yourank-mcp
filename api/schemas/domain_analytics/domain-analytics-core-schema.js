...
export const DomainAnalyticsCoreApis = [
    {
        id: "dataforseo-domain-analytics-core",
        name: "Domain Analytics Core API",
        description: "Core Domain Analytics API mit 2 essentiellen Endpunkten für Task-Management: ID List für abgeschlossene Tasks und Error Handling für fehlerhafte Anfragen.",
