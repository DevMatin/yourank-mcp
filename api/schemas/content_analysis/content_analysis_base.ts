...
export const ContentAnalysisBaseApis: ToolApi[] = [
  {
    id: "dataforseo-content-analysis-base",
    name: "Content Analysis Base API",
    description:
      "Grundlegende Content Analysis APIs mit 5 verschiedenen Endpunkten für ID-Listen, Filter, Standorte, Sprachen und Kategorien. Optimiert für Basiskonfiguration und Metadaten.",
    ...
    schema: {
      ...
      info: {
        ...
        description:
          "5 APIs für grundlegende Content Analysis Funktionen - ID-Listen, Filter, Standorte, Sprachen und Kategorien. Optimiert für Basiskonfiguration und Metadaten.",
        version: "v1.0.0",
        contact: {
          name: "DataForSEO",
