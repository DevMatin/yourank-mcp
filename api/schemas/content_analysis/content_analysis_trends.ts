...
export const ContentAnalysisTrendsApis: ToolApi[] = [
  {
    ...
    schema: {
      ...
      info: {
        ...
        description:
          "2 APIs für Content Analysis Trend-Analysen - Phrase-Trends und Kategorie-Trends. Optimiert für zeitbasierte Analyse von Zitationen.",
        version: "v1.0.0",
        contact: {
          name: "DataForSEO",
