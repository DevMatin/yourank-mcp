...
export const ContentAnalysisGeneralSchema = [
    {
        id: "dataforseo-content-analysis-general",
        name: "Content Analysis General API - Alle Content Analysis Funktionen",
        description: "Vereinheitlichte Content Analysis API mit allen Funktionen: Base APIs, Search APIs, Sentiment APIs und Trends APIs. Umfassende Content-Analyse für Zitationsdaten, Sentiment und Trends.",
        ...
        schema: {
            ...
            info: {
                ...
                description: "Vereinheitlichte API für alle Content Analysis Funktionen: Base APIs, Search APIs, Sentiment APIs und Trends APIs. Optimiert für umfassende Content-Analyse und Zitationsdaten.",
                version: "v1.0.0",
                contact: {
                    name: "DataForSEO",
