...
export const TrendsLabsApis = [
    {
        id: "dataforseo-trends-labs",
        name: "Trends Labs API",
        description: "Spezialisierte Trends-Analyse mit 5 verschiedenen APIs für historische Daten, Trend-Analysen und zeitbezogene SEO-Metriken. Optimiert für Trend-Analysen.",
        ...
        schema: {
            openapi: "3.1.0",
            info: {
                title: "DataForSEO Trends Labs API - Vollständige Trend-Analyse",
                description: "5 APIs für historische Keyword-Daten, SERP-Historie, Ranking-Trends und Traffic-Entwicklung. Spezialisiert auf zeitbezogene SEO-Analysen.",
                version: "v1.0.0",
                contact: {
                    name: "DataForSEO",
