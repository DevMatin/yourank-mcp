...
export const GoogleLabsApis = [
    {
        id: "dataforseo-google-labs",
        name: "Google Labs API",
        description: "Umfassende Google-Analyse mit 22 verschiedenen APIs für Keywords, Domains, SEO-Metriken und historische Daten. Optimiert für Google-spezifische Analysen.",
        ...
        schema: {
            ...
            info: {
                ...
                description: "22 APIs für Google Keywords, Domain-Analysen, SEO-Metriken und historische Daten. Spezialisiert auf Google Search Engine Optimization.",
                version: "v1.0.0",
                contact: {
                    name: "DataForSEO",
