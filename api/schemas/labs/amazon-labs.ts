...
export const AmazonLabsApis: ToolApi[] = [
  {
    ...
    schema: {
      ...
      info: {
        title:
          "DataForSEO Amazon Labs API - Vollständige Amazon-Analyse",
        description:
          "5 APIs für Amazon Keywords, Produkt-Analysen, Ranking-Daten und Konkurrenz-Analysen. Spezialisiert auf Amazon Marketplace Optimization.",
        version: "v1.0.0",
        contact: {
          name: "DataForSEO",
