...
export const BingLabsApis = [
    {
        id: "dataforseo-bing-labs",
        name: "Bing Labs API",
        description: "Spezialisierte Bing-Analyse mit 11 verschiedenen APIs für Bing Organic Search, Keyword-Analyse und Domain-Metriken. Optimiert für Bing-spezifische SEO-Analysen.",
        category: "Bing Labs",
        icon: "",
        ...
        schema: {
            ...
            info: {
                ...
                description: "11 APIs für Bing Keywords, Domain-Analysen, Traffic-Schätzungen und Konkurrenz-Analysen. Spezialisiert auf Bing Search Engine Optimization.",
                version: "v1.0.0",
                contact: {
                    name: "DataForSEO",
