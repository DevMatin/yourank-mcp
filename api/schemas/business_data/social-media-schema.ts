...
export const SocialMediaApis: ToolApi[] = [
  {
    ...
    schema: {
      ...
      info: {
        ...
        description:
          "3 APIs für Social Media Engagement-Analyse mit Pinterest Pins, Facebook Likes und Reddit Shares für Content-Performance-Bewertung.",
        version: "v1.0.0",
        contact: {
          name: "DataForSEO",
