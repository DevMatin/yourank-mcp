...
export const GoogleBusinessApis: ToolApi[] = [
  {
    ...
    schema: {
      ...
      info: {
        ...
        description:
          "4 APIs für Google Business Profile mit Standorten, Sprachen und detaillierten Geschäftsinformationen für lokale SEO-Analyse.",
        version: "v1.0.0",
        contact: {
          name: "DataForSEO",
