...
export const GoogleMapsApis = [
    {
        id: "dataforseo-google-maps",
        name: "Google Maps API",
        description: "Google Maps Business Listings mit 5 APIs für lokale Geschäftssuche, Kategorien, Filter und Standorte. Optimiert für lokale SEO und Business-Discovery.",
        ...
        schema: {
            ...
            info: {
                ...
                description: "5 APIs für Google Maps Business Listings mit lokaler Geschäftssuche, Kategorien und detaillierten Standortdaten für lokale SEO.",
                version: "v1.0.0",
                contact: {
                    name: "DataForSEO",
