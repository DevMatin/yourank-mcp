...
export const MerchantCoreApis = [
    {
        id: "dataforseo-merchant-core",
        name: "Merchant Core API",
        description: "Grundlegende Merchant-Funktionen: ID-Listen, Fehlerbehandlung, Screenshots und Aufgabenverwaltung. E-Commerce-übergreifende Utilities.",
