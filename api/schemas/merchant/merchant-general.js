...
export const MerchantGeneralCompleteSchema = [
    {
        id: "dataforseo-merchant-general-complete",
        name: "Merchant General API - Vollständiges Schema (48 Tools)",
        description: "Vollständige Merchant API mit ALLEN 48 implementierten Tools: 3 Core APIs, 22 Google Shopping Tools (Products, Sellers, Product Spec, Product Info), 23 Amazon Tools (Products, ASIN, Sellers, Reviews) inkl. Locations/Languages. Umfassende E-Commerce-Analyse für Google Shopping und Amazon Marketplace.",
        ...
        schema: {
            ...
            info: {
                ...
                description: "Vollständige API für ALLE 48 implementierten Merchant Tools: Core APIs (3), Google Shopping Tools (22), Amazon Tools (23). Optimiert für umfassende E-Commerce-Analyse mit vollständigen Task-Management-Zyklen.",
                version: "v3.0.0",
                contact: {
                    name: "DataForSEO",
