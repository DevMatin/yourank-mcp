...
// Lighthouse Summary Endpoint - kompakte Response für Task-Ergebnisse
...
app.post('/v3/on_page/id_list', async (req, res) => {
    try {
        console.log('🚀 OnPage ID List Route called!');
        console.log('🚀 Request body:', JSON.stringify(req.body, null, 2));
...
app.post('/v3/on_page/errors', async (req, res) => {
    try {
        console.log('🚀 OnPage Errors Route called!');
        console.log('🚀 Request body:', JSON.stringify(req.body, null, 2));
...
app.post('/v3/on_page/lighthouse/summary', async (req, res) => {
    try {
        console.log('🚀 Lighthouse Summary Route called!');
        console.log('🚀 Request body:', JSON.stringify(req.body, null, 2));
...
app.post('/v3/keywords_dataforseo_trends', async (req, res) => {
    try {
            ...
            try {
                ...
                if (locationsResponse.status === 200 && locationsResponse.body.tasks && locationsResponse.body.tasks[0].result) {
                    ...
                    if (matchingLocation) {
                        ...
                        console.log(`✅ Found location_code: ${location_code} for "${location_name}"`);
                    } else {
                        console.log(`⚠️ No matching location found for "${location_name}", using default: ${location_code}`);
                    }
                }
            } catch (error) {
                console.log(`⚠️ Error converting location, using default: ${location_code}`);
            }
        }
        ...
        console.log('🔧 DataForSEO Trends Request Data:', JSON.stringify(requestData, null, 2));
