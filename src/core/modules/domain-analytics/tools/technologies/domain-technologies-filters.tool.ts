...
export class DomainTechnologiesFiltersTool extends BaseTool {
  ...
  private static readonly TOOL_TO_FILTER_MAP: { [key: string]: string } = {
    'domain_analytics_technologies_domains_by_technology_live': 'domains_by_technology',
    'domain_analytics_technologies_aggregation_technologies_live': 'aggregation_technologies',
    'domain_analytics_technologies_technologies_summary_live': 'technologies_summary',
    'domain_analytics_technologies_domains_by_html_terms_live': 'domains_by_html_terms'
  };
  ...
  getName(): string {
    return 'domain_technologies_filters';
  }
