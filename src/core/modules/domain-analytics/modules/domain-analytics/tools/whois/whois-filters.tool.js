...
WhoisFiltersTool.cache = null;
WhoisFiltersTool.lastFetchTime = 0;
WhoisFiltersTool.CACHE_TTL = 24 * 60 * 60 * 1000; // 24 hours in milliseconds
// Map of tool names to their corresponding filter paths in the API response
WhoisFiltersTool.TOOL_TO_FILTER_MAP = {
