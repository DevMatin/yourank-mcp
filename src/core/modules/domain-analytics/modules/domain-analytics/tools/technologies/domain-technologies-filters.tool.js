...
DomainTechnologiesFiltersTool.cache = null;
DomainTechnologiesFiltersTool.lastFetchTime = 0;
DomainTechnologiesFiltersTool.CACHE_TTL = 24 * 60 * 60 * 1000; // 24 hours in milliseconds
// Map of tool names to their corresponding filter paths in the API response
DomainTechnologiesFiltersTool.TOOL_TO_FILTER_MAP = {
