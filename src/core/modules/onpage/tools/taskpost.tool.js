    ...
    async handle(params) {
        try {
            ...
            if (params.start_url !== undefined)
                requestData.start_url = params.start_url;
            ...
            if (params.enable_browser_rendering !== undefined)
                requestData.enable_browser_rendering = params.enable_browser_rendering;
            if (params.load_resources !== undefined)
                requestData.load_resources = params.load_resources;
            if (params.custom_settings !== undefined)
                requestData.custom_settings = params.custom_settings;
