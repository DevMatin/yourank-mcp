...
export class LighthouseLiveTool extends BaseTool {
    ...
    async handle(params) {
        try {
            ...
            if (params.for_mobile !== undefined)
                requestData.for_mobile = params.for_mobile;
            if (params.categories !== undefined)
                requestData.categories = params.categories;
            if (params.audits !== undefined)
                requestData.audits = params.audits;
