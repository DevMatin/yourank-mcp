...
export class PageScreenshotTool extends BaseTool {
    ...
    async handle(params) {
        try {
            ...
            if (params.viewport_width !== undefined)
                requestData.viewport_width = params.viewport_width;
            if (params.viewport_height !== undefined)
                requestData.viewport_height = params.viewport_height;
