...
export class DataForSeoTrendsDemographyTool extends BaseTool {
  ...
  async handle(params: DemographyParams): Promise<any> {
    try {
      const response = await this.client.makeRequest('/v3/keywords_data/dataforseo_trends/demography/live', 'POST', [{
