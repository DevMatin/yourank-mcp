...
interface GoogleAdsKeywordsForKeywordsTaskPostParams {
  keywords: string[];
...
interface GoogleAdsKeywordsForKeywordsTaskPostRequest {
  keywords: string[];
  location_name?: string;
  language_code?: string;
  postback_url?: string;
...
export class GoogleAdsKeywordsForKeywordsTaskPostTool extends BaseTool {
  ...
  async handle(params: GoogleAdsKeywordsForKeywordsTaskPostParams): Promise<any> {
    try {
      const requestData: GoogleAdsKeywordsForKeywordsTaskPostRequest = {
