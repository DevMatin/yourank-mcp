...
export class TrustpilotReviewsTaskPostTool extends BaseTool {
  ...
  getName(): string {
    return 'trustpilot_reviews_task_post';
  }
  ...
  getParams() {
    return {
      domain: z.string().describe('domain required field the domain of the business entity you want to receive reviews for example: "example.com"'),
  ...
  async handle(params: any) {
    ...
    return await this.dataForSEOClient.makeRequest('/v3/business_data/trustpilot/reviews/task_post', 'POST', requestData);
  }
}
