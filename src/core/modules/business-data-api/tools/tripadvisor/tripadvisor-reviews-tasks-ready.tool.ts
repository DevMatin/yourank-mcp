...
export class TripadvisorReviewsTasksReadyTool extends BaseTool {
  ...
  getName(): string {
    return 'tripadvisor_reviews_tasks_ready';
  }
  ...
  async handle(params: any) {
    return await this.dataForSEOClient.makeRequest('/v3/business_data/tripadvisor/reviews/tasks_ready', 'POST', 'GET');
  }
}
