...
export class TripadvisorSearchTaskPostTool extends BaseTool {
  ...
  getName(): string {
    return 'tripadvisor_search_task_post';
  }
  ...
  async handle(params: any) {
    ...
    return await this.dataForSEOClient.makeRequest('/v3/business_data/tripadvisor/search/task_post', 'POST', requestData);
  }
}
