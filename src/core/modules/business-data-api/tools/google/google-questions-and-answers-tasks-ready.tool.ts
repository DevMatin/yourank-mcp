...
export class GoogleQuestionsAndAnswersTasksReadyTool extends BaseTool {
  ...
  getName(): string {
    return 'google_questions_and_answers_tasks_ready';
  }
  ...
  async handle(params: any) {
    return await this.dataForSEOClient.makeRequest('/v3/business_data/google/questions_and_answers/tasks_ready', 'POST', 'GET');
  }
}
