...
export class GoogleExtendedReviewsTasksReadyTool extends BaseTool {
  ...
  getName(): string {
    return 'google_extended_reviews_tasks_ready';
  }
  ...
  async handle(params: any) {
    return await this.dataForSEOClient.makeRequest('/v3/business_data/google/extended_reviews/tasks_ready', 'POST', 'GET');
  }
}
