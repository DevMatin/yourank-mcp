...
export class GoogleQuestionsAndAnswersTaskPostTool extends BaseTool {
  ...
  getName(): string {
    return 'google_questions_and_answers_task_post';
  }
  ...
  async handle(params: any) {
    ...
    return await this.dataForSEOClient.makeRequest('/v3/business_data/google/questions_and_answers/task_post', 'POST', requestData);
  }
}
