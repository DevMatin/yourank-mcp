...
export class GoogleReviewsTaskPostTool extends BaseTool {
  ...
  getName(): string {
    return 'google_reviews_task_post';
  }
  ...
  async handle(params: any) {
    ...
    return await this.dataForSEOClient.makeRequest('/v3/business_data/google/reviews/task_post', 'POST', requestData);
  }
}
