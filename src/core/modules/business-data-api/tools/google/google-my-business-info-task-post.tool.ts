...
export class GoogleMyBusinessInfoTaskPostTool extends BaseTool {
  ...
  getName(): string {
    return 'google_my_business_info_task_post';
  }
  ...
  async handle(params: any) {
    ...
    return await this.dataForSEOClient.makeRequest('/v3/business_data/google/my_business_info/task_post', 'POST', requestData);
  }
}
