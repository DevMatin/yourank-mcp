...
export class GoogleMyBusinessInfoTaskGetTool extends BaseTool {
  ...
  getName(): string {
    return 'google_my_business_info_task_get';
  }

  getDescription(): string {
    return 'Get results of a completed Google My Business Info task by task ID.';
  }
  ...
  async handle(params: any) {
    return await this.client.makeRequest(`/v3/business_data/google/my_business_info/task_get/${params.id}`, 'POST', 'GET');
  }
}
