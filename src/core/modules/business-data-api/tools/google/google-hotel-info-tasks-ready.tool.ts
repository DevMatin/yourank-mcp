...
export class GoogleHotelInfoTasksReadyTool extends BaseTool {
  ...
  getName(): string {
    return 'google_hotel_info_tasks_ready';
  }
  ...
  async handle(params: any) {
    return await this.dataForSEOClient.makeRequest('/v3/business_data/google/hotel_info/tasks_ready', 'POST', 'GET');
  }
}
