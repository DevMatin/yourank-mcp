...
export class GoogleHotelSearchesTasksReadyTool extends BaseTool {
  ...
  getName(): string {
    return 'google_hotel_searches_tasks_ready';
  }
  ...
  async handle(params: any) {
    return await this.dataForSEOClient.makeRequest('/v3/business_data/google/hotel_searches/tasks_ready', 'POST', 'GET');
  }
}
