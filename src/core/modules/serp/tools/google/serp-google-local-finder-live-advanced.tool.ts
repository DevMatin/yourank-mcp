...
export class SerpGoogleLocalFinderLiveAdvancedTool extends BaseTool {
  ...
  getDescription(): string {
    return 'Get Google Local Finder search results with advanced features';
  }
  ...
  async handle(params: any): Promise<any> {
    try {
      ...
      const response = await this.dataForSEOClient.makeRequest('/v3/serp/google/local_finder/live/advanced', 'POST', [requestData]);
