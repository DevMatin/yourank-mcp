...
exports.BacklinksDomainIntersectionTool = void 0;
const zod_1 = require("zod");
const base_tool_js_1 = require("../../base.tool.js");
const map_array_to_numbered_keys_js_1 = require("../../../utils/map-array-to-numbered-keys.js");
class BacklinksDomainIntersectionTool extends base_tool_js_1.BaseTool {
    constructor(client) {
        super(client);
        this.client = client;
    }
    ...
    getParams() {
        return {
            targets: zod_1.z.array(zod_1.z.string()).describe(`domains, subdomains or webpages to get links for
required field
you can set up to 20 domains, subdomains or webpages
a domain or a subdomain should be specified without https:// and www.
a page should be specified with absolute URL (including http:// or https://)`),
            limit: zod_1.z.number().min(1).max(1000).default(10).optional().describe("the maximum number of returned results"),
            offset: zod_1.z.number().min(0).optional().describe(`offset in the array of returned results
optional field
default value: 0
    ...
    async handle(params) {
        try {
            const response = await this.client.makeRequest('/v3/backlinks/domain_intersection/live', 'POST', [{
                    targets: (0, map_array_to_numbered_keys_js_1.mapArrayToNumberedKeys)(params.targets),
                    limit: params.limit,
...
exports.BacklinksDomainIntersectionTool = BacklinksDomainIntersectionTool;
