...
exports.BacklinksReferringNetworksTool = void 0;
const zod_1 = require("zod");
const base_tool_js_1 = require("../../base.tool.js");
class BacklinksReferringNetworksTool extends base_tool_js_1.BaseTool {
    constructor(client) {
        super(client);
        this.client = client;
    }
...
a page should be specified with absolute URL (including http:// or https://)`),
            network_address_type: zod_1.z.string().optional().default('ip').describe(`indicates the type of network to get data for
optional field
possible values: ip, subnet
default value: ip`),
            limit: zod_1.z.number().min(1).max(1000).default(10).optional().describe("the maximum number of returned networks"),
...
exports.BacklinksReferringNetworksTool = BacklinksReferringNetworksTool;
