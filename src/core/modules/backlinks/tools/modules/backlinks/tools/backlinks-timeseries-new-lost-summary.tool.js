...
exports.BacklinksTimeseriesNewLostSummaryTool = void 0;
const zod_1 = require("zod");
const base_tool_js_1 = require("../../base.tool.js");
class BacklinksTimeseriesNewLostSummaryTool extends base_tool_js_1.BaseTool {
    constructor(client) {
        super(client);
        this.client = client;
    }
...
`;
    ...
    getParams() {
        return {
            target: zod_1.z.string().describe(`domain to get data for
required field
a domain should be specified without https:// and www.
example:
"forbes.com"`),
            date_from: zod_1.z.string().describe(`starting date of the time range
optional field
...
example:
"2021-01-01"`).optional(),
            date_to: zod_1.z.string().describe(`ending date of the time range
optional field
...
example:
"2021-01-15"`).optional(),
            group_range: zod_1.z.string().optional().describe(`time range which will be used to group the results
optional field
default value: month
...
exports.BacklinksTimeseriesNewLostSummaryTool = BacklinksTimeseriesNewLostSummaryTool;
