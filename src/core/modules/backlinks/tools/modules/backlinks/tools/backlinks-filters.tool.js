...
exports.BacklinksFiltersTool = void 0;
const zod_1 = require("zod");
const base_tool_js_1 = require("../../base.tool.js");
class BacklinksFiltersTool extends base_tool_js_1.BaseTool {
    constructor(client) {
        super(client);
        this.client = client;
    }
...
Please, keep in mind that filters are associated with a certain object in the result array, and should be specified accordingly.`;
    ...
    getParams() {
        return {
            tool: zod_1.z.string().optional().describe('The name of the tool to get filters for')
        };
    }
...
exports.BacklinksFiltersTool = BacklinksFiltersTool;
BacklinksFiltersTool.cache = null;
BacklinksFiltersTool.lastFetchTime = 0;
BacklinksFiltersTool.CACHE_TTL = 24 * 60 * 60 * 1000; // 24 hours in milliseconds
