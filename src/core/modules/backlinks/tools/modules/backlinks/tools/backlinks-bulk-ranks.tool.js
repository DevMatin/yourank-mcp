...
exports.BacklinksBulkRanksTool = void 0;
const zod_1 = require("zod");
const base_tool_js_1 = require("../../base.tool.js");
class BacklinksBulkRanksTool extends base_tool_js_1.BaseTool {
    constructor(client) {
        super(client);
        this.client = client;
    }
...
"www.trustpilot.com"
            ...
            rank_scale: zod_1.z.string().optional().describe(`defines the scale used for calculating and displaying the rank, domain_from_rank, and page_from_rank values
optional field
...
exports.BacklinksBulkRanksTool = BacklinksBulkRanksTool;
