...
exports.BacklinksHistoryTool = void 0;
const zod_1 = require("zod");
const base_tool_js_1 = require("../../base.tool.js");
class BacklinksHistoryTool extends base_tool_js_1.BaseTool {
    constructor(client) {
        super(client);
        this.client = client;
    }
    ...
    getParams() {
        return {
            target: zod_1.z.string().describe(`domain, subdomain or webpage to get historical backlinks data for
        required field
a domain or a subdomain should be specified without https:// and www.
a page should be specified with absolute URL (including http:// or https://)`),
            date_from: zod_1.z.string().optional().describe("start date for historical data (format: YYYY-MM-DD)"),
            date_to: zod_1.z.string().optional().describe("end date for historical data (format: YYYY-MM-DD)"),
    ...
    async handle(params) {
        try {
            ...
            if (params.include_subdomains !== undefined)
                requestData.include_subdomains = params.include_subdomains;
            if (params.exclude_internal_backlinks !== undefined)
                requestData.exclude_internal_backlinks = params.exclude_internal_backlinks;
...
exports.BacklinksHistoryTool = BacklinksHistoryTool;
