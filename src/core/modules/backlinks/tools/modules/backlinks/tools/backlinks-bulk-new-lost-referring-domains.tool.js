...
exports.BacklinksBulkNewLostReferringDomainsTool = void 0;
const zod_1 = require("zod");
const base_tool_js_1 = require("../../base.tool.js");
class BacklinksBulkNewLostReferringDomainsTool extends base_tool_js_1.BaseTool {
    constructor(client) {
        super(client);
        this.client = client;
    }
...
"www.trustpilot.com"
            ...
            date_from: zod_1.z.string().optional().describe(`starting date of the time range
optional field
...
exports.BacklinksBulkNewLostReferringDomainsTool = BacklinksBulkNewLostReferringDomainsTool;
