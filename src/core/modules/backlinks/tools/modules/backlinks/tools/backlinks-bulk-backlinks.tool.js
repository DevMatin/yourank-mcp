...
exports.BacklinksBulkBacklinksTool = void 0;
const zod_1 = require("zod");
const base_tool_js_1 = require("../../base.tool.js");
class BacklinksBulkBacklinksTool extends base_tool_js_1.BaseTool {
    constructor(client) {
        super(client);
        this.client = client;
    }
...
exports.BacklinksBulkBacklinksTool = BacklinksBulkBacklinksTool;
