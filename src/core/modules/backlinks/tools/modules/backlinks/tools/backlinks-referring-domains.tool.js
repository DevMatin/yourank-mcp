...
exports.BacklinksReferringDomainsTool = void 0;
const zod_1 = require("zod");
const base_tool_js_1 = require("../../base.tool.js");
class BacklinksReferringDomainsTool extends base_tool_js_1.BaseTool {
    constructor(client) {
        super(client);
        this.client = client;
    }
...
a page should be specified with absolute URL (including http:// or https://)`),
            limit: zod_1.z.number().min(1).max(1000).default(10).optional().describe("the maximum number of returned pages"),
            offset: zod_1.z.number().min(0).optional().describe(`offset in the results array of returned pages
optional field
default value: 0
...
exports.BacklinksReferringDomainsTool = BacklinksReferringDomainsTool;
