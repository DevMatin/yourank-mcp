...
export class GoogleRelevantPagesTool extends BaseTool {
  ...
  getName(): string {
    return 'google_relevant_pages';
  }

  getDescription(): string {
    return 'Provides you with rankings and traffic data for the web pages of the specified domain';
  }
  ...
  getParams(): z.ZodRawShape {
    return {
      ...
      limit: z.number().optional().describe("Maximum number of returned pages. Default value: 100, maximum value: 1000"),
  ...
  async handle(params: any): Promise<any> {
    try {
      ...
      const response = await this.client.makeRequest('/v3/dataforseo_labs/google/relevant_pages/live', 'POST', [requestData]);
