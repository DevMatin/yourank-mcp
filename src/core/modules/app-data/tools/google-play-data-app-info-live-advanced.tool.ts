...
export class GooglePlayDataAppInfoLiveAdvancedTool extends BaseTool {
  constructor(dataForSEOClient: DataForSEOClient) {
    super(dataForSEOClient);
  }

  getName(): string {
    return 'google_play_data_app_info_live_advanced';
  }

  getDescription(): string {
    return 'Get information about a specific Google Play application including its ID, icon, description, reviews count, rating, number of installs, images, and detailed metadata.';
  }
