...
export class GooglePlaySearchLiveAdvancedTool extends BaseTool {
  constructor(dataForSEOClient: DataForSEOClient) {
    super(dataForSEOClient);
  }

  getName(): string {
    return 'google_play_search_live_advanced';
  }

  getDescription(): string {
    return 'Get a list of apps ranking on Google Play for a specified keyword with additional information like ID, icon, reviews count, rating, price, and other data. Results are specific to the keyword, language, and location parameters.';
  }
