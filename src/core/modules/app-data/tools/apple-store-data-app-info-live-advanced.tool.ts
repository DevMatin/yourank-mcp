...
export class AppleStoreDataAppInfoLiveAdvancedTool extends BaseTool {
  constructor(dataForSEOClient: DataForSEOClient) {
    super(dataForSEOClient);
  }

  getName(): string {
    return 'apple_store_data_app_info_live_advanced';
  }

  getDescription(): string {
    return 'Get information about a specific Apple App Store application including its ID, icon, description, reviews count, rating, images, and detailed metadata.';
  }
